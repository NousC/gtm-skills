...
| [`sales-nav-builder`](.claude/skills/sales-nav-builder/SKILL.md) | Turn a LinkedIn Sales Navigator search into a clean, verified lead list. Claude builds the exact Sales Nav search from your ICP, Evaboot extracts it and verifies every email, deduped against Nous, saved to a lead list. The sharpest targeting, for Sales Nav users |
